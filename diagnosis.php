...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO diagnosis (diagnosisID, diagnosisname, diagnosisdescription, diagnosisprice) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['diagnosisID'], "int"),
                       GetSQLValueString($_POST['diagnosisname'], "text"),
                       GetSQLValueString($_POST['diagnosisdescription'], "text"),
                       GetSQLValueString($_POST['diagnosisprice'], "int"));
  ...
  <tr>
   ...
   <center>
     <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
       <table align="center">
         <tr valign="baseline">
           <td nowrap="nowrap" align="right">Diagnosis ID:</td>
           <td><input type="text" name="diagnosisID" value="" size="32" /></td>
         </tr>
         <tr valign="baseline">
           <td nowrap="nowrap" align="right">Diagnosis Name:</td>
           <td><input type="text" name="diagnosisname" value="" size="32" /></td>
         </tr>
         <tr valign="baseline">
           <td nowrap="nowrap" align="right">Diagnosis Description:</td>
           <td><input type="text" name="diagnosisdescription" value="" size="32" /></td>
         </tr>
         <tr valign="baseline">
           <td nowrap="nowrap" align="right">Diagnosis Price:</td>
           <td><input type="text" name="diagnosisprice" value="" size="32" /></td>
         </tr>
         <tr valign="baseline">
           <td nowrap="nowrap" align="right">&nbsp;</td>
           <td><input type="submit" value="Save Diagnosis" />
