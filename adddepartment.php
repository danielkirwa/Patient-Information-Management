...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO department (departmentID, departmentname, departmentdescription) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['departmentID'], "int"),
                       GetSQLValueString($_POST['departmentname'], "text"),
                       GetSQLValueString($_POST['departmentdescription'], "text"));
     ...
     <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
       <table align="center">
         ...
         <tr valign="baseline">
           ...
           <td><input type="text" name="departmentname" value="" size="32" /></td>
         </tr>
         <tr valign="baseline">
           <td nowrap="nowrap" align="right">Departmentdescription:</td>
           <td><input type="text" name="departmentdescription" value="" size="32" /></td>
         </tr>
         <tr valign="baseline">
