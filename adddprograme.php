...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO programe (programeID, programename, programedescription, departmentID) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['programeID'], "int"),
                       GetSQLValueString($_POST['programename'], "text"),
                       GetSQLValueString($_POST['programedescription'], "text"),
   ...
   <center>
     <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
       <table align="center">
         ...
         <tr valign="baseline">
           <td nowrap="nowrap" align="right">Programename:</td>
           <td><input type="text" name="programename" value="" size="32" /></td>
         </tr>
         <tr valign="baseline">
           <td nowrap="nowrap" align="right">Programedescription:</td>
           <td><input type="text" name="programedescription" value="" size="32" /></td>
         </tr>
         <tr valign="baseline">
